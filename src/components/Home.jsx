...
export default function Home() {
  return (
    <>
    <div className="mainContainer  w-screen h-screen bg-slate-200">
    <div className="subContainer overflow-x-hidden w-screen grid grid-cols-3 gap-x-28 justify-around absolute top-60  ">
